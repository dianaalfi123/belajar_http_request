...
class HomeProviderGet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final dataProvider = Provider.of<HttpProviderGet>(context, listen: false);
    return Scaffold(
      appBar: AppBar(
      ...
      body: ListView(
        ...
        children: [
          Column(mainAxisAlignment: MainAxisAlignment.center, children: [
            ClipRRect(
              ...
              child: Container(
                  height: 100,
                  width: 100,
                  child: Consumer<HttpProviderGet>(
          ...
          OutlinedButton(
            onPressed: () {
              // dataProvider.
              dataProvider.connetApi((1 + Random().nextInt(10)).toString());
            },
            child: Text(
              "GET DATA",
              style: TextStyle(
